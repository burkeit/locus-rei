...
CREATE TABLE IF NOT EXISTS `locus_rei`.`Things` (
  ...
  `External_Label` VARCHAR(64) NULL COMMENT 'An alternate ID for this thing’s primary DB. ',
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `locus_rei`.`Objects` (`ID` INT, `Barcode` INT, `Name` INT, `External_Label` INT, `DeptName` INT, `LocationCode` INT, `LocationType` INT, `Status` INT);

-- -----------------------------------------------------
-- Placeholder table for view `locus_rei`.`Locations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `locus_rei`.`Locations` (`ID` INT, `Barcode` INT, `External_Label` INT, `Name` INT, `Type` INT, `ParentLoc` INT, `ParentType` INT, `ParentBarcode` INT);
